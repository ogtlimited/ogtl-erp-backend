...
class AttendanceRoute implements Routes {
    ...
    private initializeRoutes() {
      ...
      this.router.post(`${this.path}/manual-attendance`, [authMiddleware, validationMiddleware(CreateManualAttendanceDto, 'body')], this.AttendanceController.createManualAttendanceToPostgresQL);
