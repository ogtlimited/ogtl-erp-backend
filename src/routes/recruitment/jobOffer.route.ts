...
class JobOfferRoute implements  Routes{
  ...
  private initializeRoutes(){
    ...
    this.router.post(`${this.path}`,authMiddleware,validationMiddleware(CreateJobOfferDto,'body'),this.jobOfferController.createJobOffer);
    this.router.patch(`${this.path}/:id`,authMiddleware, validationMiddleware(UpdateJobOfferDto, 'body'), this.jobOfferController.updateJobOffer);
