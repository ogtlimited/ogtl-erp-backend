...
class JobApplicantRoute implements Routes{
  ...
  private initializeRoutes(){
    ...
    this.router.post(`${this.path}`,[validationMiddleware(CreateJobApplicantDto,'body'),authMiddleware],this.jobApplicantController.createJobApplicant);
    this.router.patch(`${this.path}/:id`,[validationMiddleware(UpdateJobApplicantDto, 'body'),authMiddleware], this.jobApplicantController.updateJobApplicant);
