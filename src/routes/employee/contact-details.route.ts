...
class ContactDetailsRoute implements Routes {
    ...
    private initializeRoutes() {
        ...
        this.router.post(`${this.path}`,[validationMiddleware(CreateContactDetailsDto, 'body'),authMiddleware], this.ContactDetailsController.CreateContactDetails);
        this.router.put(`${this.path}/:id`, [validationMiddleware(UpdateContactDetailsDto, 'body', true),authMiddleware], this.ContactDetailsController.updateContactDetails);
