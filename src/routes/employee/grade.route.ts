...
class GradeRoute implements Routes {
    ...
    private initializeRoutes() {
        ...
        this.router.post(`${this.path}`, [validationMiddleware(CreateGradeDto, 'body'),authMiddleware], this.GradeController.CreateGrade);
        this.router.put(`${this.path}/:id`, [validationMiddleware(UpdateGradeDto, 'body', true),authMiddleware], this.GradeController.updateGrade);
