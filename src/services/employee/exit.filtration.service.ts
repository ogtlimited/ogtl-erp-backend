            ...
            filtrationQuery.push(
                {
                    $match: {
                        $or: [
                            { "employee_id.first_name": { $regex: searchQuery.search, $options: "i" } },
                            { "employee_id.last_name": { $regex: searchQuery.search, $options: "i" } },
                            { "employee_id.middle_name": { $regex: searchQuery.search, $options: "i" } }
                        ]
                    }
                }
            )
...
export default ExitFiltrationService