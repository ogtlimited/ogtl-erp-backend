...
class Filtration{
private async getLeaveApplicationsHelperMethod(matchBy,searchQuery:any, model): Promise<any> {
    let MAX_LIMIT = 50
    ...
    const application: any = await this.modelName
    ...
    const countDocuments: any = await this.modelName.aggregate(removeLimitAndSkip)
